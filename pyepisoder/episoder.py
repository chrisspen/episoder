...
class DataStore(object):
    ...
    def getShowById(self, id): # pylint: disable=redefined-builtin
    ...
    def removeShow(self, id): # pylint: disable=redefined-builtin
    ...
    def removeBefore(self, dt, show=None):
...
class Show(object):
    ...
    def __init__(self, name, id=-1, url='', updated=date(1970, 1, 1)): #pylint: disable=redefined-builtin
    ...
    def removeEpisodesBefore(self, store, dt):

        logging.debug('Removing episodes from before %s', dt)
        store.removeBefore(dt, show=self)
